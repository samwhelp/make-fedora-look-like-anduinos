...
* [Requirement](https://github.com/samwhelp/make-fedora-look-like-anduinos/blob/main/requirement.md)
* [Keybind](https://github.com/samwhelp/make-fedora-look-like-anduinos/blob/main/keybind.md)
* [Howto](#howto)
* [Extension](#extension)
* [Theme](#theme)
* [Wallpaper](#wallpaper)
...
### How to download [make-fedora-look-like-anduinos.sh](https://github.com/samwhelp/make-fedora-look-like-anduinos/blob/main/make-fedora-look-like-anduinos.sh) and run [it](https://raw.githubusercontent.com/samwhelp/make-fedora-look-like-anduinos/refs/heads/main/make-fedora-look-like-anduinos.sh).

> run

``` sh
bash <(curl -L https://raw.githubusercontent.com/samwhelp/make-fedora-look-like-anduinos/refs/heads/main/make-fedora-look-like-anduinos.sh)
```
...
``` sh
bash <(wget -q https://raw.githubusercontent.com/samwhelp/make-fedora-look-like-anduinos/refs/heads/main/make-fedora-look-like-anduinos.sh -O - )
```
...
``` sh
bash -c "$(curl -fsSL https://raw.githubusercontent.com/samwhelp/make-fedora-look-like-anduinos/refs/heads/main/make-fedora-look-like-anduinos.sh || wget -q https://raw.githubusercontent.com/samwhelp/make-fedora-look-like-anduinos/refs/heads/main/make-fedora-look-like-anduinos.sh -O - )"
```
...
``` sh
bash -c "$(wget -q https://raw.githubusercontent.com/samwhelp/make-fedora-look-like-anduinos/refs/heads/main/make-fedora-look-like-anduinos.sh -O - || curl -fsSL https://raw.githubusercontent.com/samwhelp/make-fedora-look-like-anduinos/refs/heads/main/make-fedora-look-like-anduinos.sh)"
```
...
| anduinos-gnome-shell-adjustment | fedora-gnome-shell-adjustment |
| ------------------------------- | ----------------------------- |
| [gnome-shell-layout-wincity.sh](https://github.com/samwhelp/anduinos-gnome-shell-adjustment/blob/main/demo/scripts/layout/gnome-shell-layout-wincity/gnome-shell-layout-wincity.sh) | [gnome-shell-layout-wincity.sh](https://github.com/samwhelp/fedora-gnome-shell-adjustment/blob/main/demo/scripts/layout/gnome-shell-layout-wincity/gnome-shell-layout-wincity.sh) |
| [gnome-shell-layout-wincity](https://github.com/samwhelp/anduinos-gnome-shell-adjustment/tree/main/project/gnome-shell-layout/gnome-shell-layout-advance-full/profile/gnome-shell-layout-wincity) | [gnome-shell-layout-wincity](https://github.com/samwhelp/fedora-gnome-shell-adjustment/tree/main/project/gnome-shell-layout/gnome-shell-layout-advance-full/profile/gnome-shell-layout-wincity) |
